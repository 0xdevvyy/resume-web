...
use App\DTO\Awards;
use App\DTO\Certifications;
use App\DTO\Education;
use App\DTO\Interest;
use App\DTO\Languages;
use App\DTO\Project;
use App\DTO\Publication;
use App\DTO\Reference;
use App\DTO\Skill;
use App\DTO\Volunteer;
use App\DTO\Work;
...
readonly class Resume
{
     ...
     * @param Awards[]               $awards
     * @param Certifications[]         $certificates
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            work:         $extractData($data, 'work', Work  ::class),
            volunteer:    $extractData($data, 'volunteer', Volunteer::class),
            education:    $extractData($data, 'education', Education::class),
            awards:       $extractData($data, 'awards', Awards::class),
            certificates: $extractData($data, 'certificates', Certifications::class),
            publications: $extractData($data, 'publications', Publication::class),
            skills:       $extractData($data, 'skills', Skill::class),
            languages:    $extractData($data, 'languages', Languages::class),
